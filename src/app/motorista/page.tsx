...
export default function Vantagens99() {
  ...
  const benefits = [
    {
      icon: Smartphone,
      title: "Celular profissional",
      text: "Equipamento preparado para sua rotina",
    },
    {
      icon: Wifi,
      title: "Conexão garantida",
      text: "Mais estabilidade para receber corridas",
    },
    {
      icon: ShieldCheck,
      title: "Mais segurança",
      text: "Proteção e suporte para o motorista",
    },
    {
      icon: WalletCards,
      title: "Economize seu dinheiro",
      text: "Alugue sem precisar comprar um celular",
    },
  ];
  ...
  const vantagens = [
    {
      ...
      descricao:
        "Veja o valor exato da corrida antes de aceitar e tenha mais previsibilidade sobre quanto vai receber ao final.",
    },
    {
    ...
    },
    {
      ...
      descricao:
        "Caso ocorra algum problema com o pagamento da corrida, a plataforma oferece suporte e proteção para evitar prejuízos ao motorista.",
    },
    {
      titulo: "Tarifas mais equilibradas",
      descricao:
        "Os valores das corridas são ajustados de forma inteligente para considerar fatores como deslocamento e demanda da região.",
    },
    {
      titulo: "Benefícios exclusivos Maylon",
      descricao:
        "Motoristas parceiros contam com vantagens especiais, suporte dedicado e recursos pensados para trazer mais segurança, economia e praticidade no dia a dia.",
    },
  ];
    ...
    <>
        ...
        <div className="relative mx-auto flex max-w-7xl flex-col items-center gap-10 px-5 sm:px-6 md:gap-12 lg:flex-row lg:gap-16 lg:px-10 xl:gap-20 xl:px-12 2xl:px-0">
            ...
            <div className="relative h-[360px] w-[360px] xl:h-[430px] xl:w-[430px] 2xl:h-[480px] 2xl:w-[480px]">
              ...
              <div className="absolute inset-0 z-20 flex items-center justify-center">
                <Image
                  ...
                  height={400}
                  priority
                  className="translate-x-6 scale-105 object-contain drop-shadow-[0_35px_50px_rgba(0,0,0,0.45)] xl:translate-x-10 xl:scale-110"
                />
              </div>
          ...
          <div className="w-full max-w-2xl text-justify sm:text-justify lg:max-w-xl lg:text-left">
            ...
            <p className="mx-auto mt-5 max-w-xl text-sm leading-7 text-black sm:text-base md:max-w-2xl md:text-justify md:text-sm lg:mx-0 lg:text-sm lg:leading-7 xl:text-base 2xl:text-base">
              ...
              segurança e oportunidades reais para motoristas parceiros.
            </p>
          </div>
        </div>
      </section>
            ...
            {vantagens.map((item, index) => (
              ...
              >
                ...
                <div className="relative">
                  ...
                  <p className="mt-2 text-sm leading-5 text-zinc-100 text-justify sm:mt-4 sm:text-base sm:leading-7">
                    {item.descricao}
                  </p>
                </div>
              </div>
      ...
      <section className="relative w-full overflow-hidden px-3 py-4 sm:px-6 sm:py-6 lg:px-8">
        <div className="relative mx-auto max-w-[1800px] overflow-hidden rounded-[2rem] bg-[#002c27] shadow-2xl shadow-[#003c35]/30">
          ...
          <div className="pointer-events-none absolute left-1/2 top-1/2 h-[450px] w-[450px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[#12e7a5]/10 blur-[120px]" />
          ...
          <div className="relative mx-auto max-w-[1720px] px-5 py-8 sm:px-8 sm:py-10 lg:px-12 lg:py-12 xl:px-16">
            <div className="relative grid items-center gap-6 py-8 lg:grid-cols-[0.9fr_1.1fr] lg:gap-2 lg:py-4">
              <div className="relative z-20 text-center lg:text-left">
                <h1 className="max-w-xl text-3xl font-black leading-[1.05] tracking-tight text-white sm:text-4xl lg:text-4xl xl:text-5xl">
                  MAIS TECNOLOGIA
                  <br />
                  <span className="text-[#12e7a5]">PARA SUA JORNADA.</span>
                </h1>
                <h2 className="mt-5 max-w-lg text-2xl font-black leading-[1.05] text-white sm:text-3xl lg:text-3xl xl:text-4xl">
                  UM SMARTPHONE
                  <br />
                  À ALTURA DOS SEUS OBJETIVOS.
                </h2>
                <p className="mx-auto mt-6 max-w-lg text-sm leading-7 text-white/65 text-justify sm:text-base lg:mx-0">
                  Tenha um celular preparado para acompanhar cada corrida,
                  cada entrega e cada nova oportunidade. Mais desempenho,
                  conectividade e praticidade para você trabalhar com
                  tranquilidade.
                </p>
                ...
                <div className="mx-auto mt-8 max-w-md rounded-3xl border border-[#12e7a5]/30 bg-white/[0.06] p-5 text-left shadow-xl shadow-black/10 backdrop-blur-xl lg:mx-0">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <h3 className="mt-1 text-xl font-black tracking-tight text-[#12e7a5] xl:text-2xl">
                        ELEVE SUA ROTINA
                      </h3>
                      <p className="mt-2 text-xs leading-5 text-white/60">
                        Equipamento confiável para você se conectar, trabalhar
                        e aproveitar novas oportunidades todos os dias.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="relative z-10 flex min-h-[420px] items-center justify-center lg:min-h-[620px]">
                <div className="pointer-events-none absolute left-1/2 top-1/2 h-[280px] w-[280px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[#12e7a5]/20 blur-[80px] sm:h-[400px] sm:w-[400px] lg:h-[550px] lg:w-[550px]" />
                <div className="pointer-events-none absolute bottom-0 right-0 h-72 w-72 rounded-full bg-[#12e7a5]/10 blur-[100px]" />
                <div className="pointer-events-none absolute bottom-4 left-1/2 h-10 w-[240px] -translate-x-1/2 rounded-full bg-black/40 blur-2xl sm:w-[320px]" />
                <div className="relative flex h-full w-full items-end justify-center">
                  <Image
                    src="/aluguel_celular.png"
                    alt="Motorista Maylon com celular"
                    width={900}
                    height={1000}
                    priority
                    className="relative z-20 h-auto w-[300px] max-w-none object-contain drop-shadow-[0_35px_55px_rgba(0,0,0,0.60)] transition-all duration-500 hover:-translate-y-3 sm:w-[390px] md:w-[470px] lg:w-[540px] xl:w-[650px]"
                  />
                </div>
                <div className="absolute bottom-8 left-1/2 z-30 flex -translate-x-1/2 items-center gap-2 whitespace-nowrap rounded-full border border-[#12e7a5]/30 bg-[#003c35]/85 px-4 py-2 text-xs font-bold text-white shadow-xl backdrop-blur-xl sm:bottom-10 sm:px-5 sm:py-2.5">
                  <Smartphone size={16} className="text-[#12e7a5]" />
                  Celular preparado para sua rotina
                </div>
              </div>
            </div>
            <div className="relative z-20 border-t border-white/10 pt-7">
              <div className="grid gap-7 lg:grid-cols-[1.15fr_0.85fr] lg:items-end">
                <div className="grid grid-cols-2 gap-3 sm:grid-cols-4 lg:grid-cols-2 xl:grid-cols-4">
                  {benefits.map((benefit) => {
                    ...
                    return (
                      <div
                        key={benefit.title}
                        className="group rounded-2xl border border-white/10 bg-white/[0.045] p-3 backdrop-blur-md transition duration-300 hover:-translate-y-1 hover:border-[#12e7a5]/40 hover:bg-[#12e7a5]/10"
                      >
                ...
                <div className="flex flex-col items-center gap-5 lg:items-end">
                  ...
                  <button
                    type="button"
                    className="group flex w-full max-w-md cursor-pointer items-center justify-center gap-3 rounded-2xl bg-[#12e7a5] px-5 py-4 text-xs font-black tracking-wide text-[#003c35] shadow-lg shadow-[#12e7a5]/10 transition duration-300 hover:-translate-y-1 hover:bg-[#25f7b5] hover:shadow-xl hover:shadow-[#12e7a5]/20 sm:text-sm"
                  >
                    <Headset
                      size={21}
                      strokeWidth={2.5}
                    ...
                    <span className="ml-auto text-2xl leading-none transition group-hover:translate-x-1">
                      →
                    </span>
                  </button>
                </div>
              ...
              <div className="mt-7 flex flex-col items-center justify-between gap-3 border-t border-white/10 pt-5 text-center sm:flex-row sm:text-left">
                <p className="font-serif text-sm italic text-white/45">
                  Motoristas hoje, histórias maiores amanhã.
                </p>
              ...
              <div className="flex flex-col justify-center">
                ...
                <div className="mt-6 rounded-3xl bg-white p-5 shadow-2xl sm:mt-8 sm:p-6 md:p-8 lg:mt-10">
                  ...
                  <small className="mt-3 block text-[11px] leading-5 text-zinc-500 sm:text-xs">
                    * Estimativa calculada com base na média mensal de viagens
                    e no valor selecionado por corrida.
                  </small>
                </div>
              </div>
        ...
        <div className="mx-auto flex max-w-7xl flex-col-reverse items-center gap-10 px-4 py-10 sm:px-6 sm:py-13 md:gap-14 md:py-14 lg:flex-row lg:gap-20 lg:px-8 lg:py-14 xl:px-10 xl:py-14 2xl:px-12 2xl:py-14">
          <div className="relative z-10 w-full max-w-2xl text-center lg:text-left">
            ...
            <p className="mx-auto mt-3 max-w-xl text-sm leading-7 text-zinc-300 sm:text-sm md:text-sm lg:mx-0 lg:text-sm xl:text-base 2xl:text-base">
              Trabalhe nos seus horários, aumente sua renda e tenha liberdade
              para dirigir quando quiser com total flexibilidade.
            </p>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 p-4 backdrop-blur-sm">
          <div className="relative max-h-[95vh] w-full max-w-6xl overflow-y-auto rounded-[32px] bg-white shadow-2xl">
            <button
              ...
              className="absolute right-6 top-6 z-50 flex h-11 w-11 cursor-pointer items-center justify-center rounded-full bg-red-500 text-white transition hover:bg-red-600"
            >
              <X size={20} />
            </button>
            <div className="px-4 pt-8 sm:px-8">
              <div className="text-center">
                ...
                <p className="mx-auto mt-0 max-w-2xl text-sm text-zinc-500">
                  Faça seu cadastro gratuitamente e comece a receber corridas
                  em poucos passos.
                </p>
              </div>
                ...
                <div className="relative z-10 grid gap-8 md:grid-cols-2 lg:grid-cols-3">
                  <div className="relative rounded-3xl border border-zinc-200 bg-white p-4 shadow-sm transition duration-300 hover:-translate-y-2 hover:border-emerald-300 hover:shadow-xl">
                    ...
                    <p className="mt-4 text-center leading-7 text-zinc-600">
                      Envie uma foto da sua CNH com observação EAR para iniciar
                      seu cadastro.
                    </p>
                  ...
                  <div className="relative rounded-3xl border border-zinc-200 bg-white p-4 shadow-sm transition duration-300 hover:-translate-y-2 hover:border-emerald-300 hover:shadow-xl">
                    ...
                    <p className="mt-4 text-center leading-7 text-zinc-600">
                      Nossa equipe verifica sua documentação para garantir a
                  ...
                  <div className="relative rounded-3xl border border-zinc-200 bg-white p-4 shadow-sm transition duration-300 hover:-translate-y-2 hover:border-emerald-300 hover:shadow-xl md:col-span-2 md:mx-auto md:max-w-xl lg:col-span-1 lg:max-w-none">
                    ...
                    <p className="mt-4 text-center leading-7 text-zinc-600">
                      Após a aprovação, envie o CRLV do veículo e fique online
                      para receber corridas.
                    </p>
                    <div className="mt-6 rounded-2xl border border-amber-200 bg-amber-50 p-4">
                      <p className="text-sm text-amber-700 text-justify">
                        Não possui veículo? Alugue com desconto em nossas
                        locadoras parceiras.
                      </p>
                    </div>
                    <button className="mt-6 w-full cursor-pointer rounded-2xl bg-gradient-to-r from-emerald-500 to-teal-500 py-3 font-semibold text-white transition-all duration-300 hover:shadow-xl hover:shadow-emerald-300/40">
                      Alugar veículo
                    </button>
                  </div>
                </div>
              ...
              <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
                <div className="flex-1 text-center md:text-left">
                  ...
                  <p className="mt-1 text-sm text-black">
                    Faça seu cadastro e comece a dirigir com a Maylon hoje
                    mesmo.
                  </p>
                </div>
                <div className="flex shrink-0 flex-col gap-3 sm:flex-row">
                  ...
                  <Link
                    ...
                    className="rounded-2xl bg-gradient-to-r from-emerald-500 to-teal-500 px-6 py-2 text-center text-base font-semibold text-white shadow-lg transition hover:scale-105"
                  >
                    Quero ser motorista →
                  </Link>
                </div>
