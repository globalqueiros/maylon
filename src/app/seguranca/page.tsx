          ...
          <div className="grid w-full items-center lg:grid-cols-[0.9fr_1.1fr] lg:gap-10 xl:gap-4">
            <div className="relative z-10 max-w-2xl">
              ...
              <p className="mt-6 max-w-xl text-sm leading-7 text-slate-300 sm:text-base sm:leading-8">
                Na Maylon, segurança não é detalhe. Investimos em tecnologia,
                monitoramento em tempo real e processos inteligentes para
                proporcionar mais tranquilidade a passageiros e motoristas
                parceiros.
              </p>
        ...
        <div className="relative mx-auto max-w-7xl px-5 sm:px-8 lg:px-8">
          <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-20">
            ...
            <div className="max-w-xl">
              ...
              <div className="mt-6 space-y-4 text-sm leading-7 text-slate-600 sm:text-base">
                <p>
                  A Maylon utiliza tecnologia avançada, monitoramento em tempo
                  real e confirmação via OTP para oferecer mais segurança e
          ...
          <div className="mt-24 grid items-center gap-12 lg:grid-cols-2 lg:gap-20">
            <div className="order-2 max-w-xl lg:order-1">
              ...
              <div className="mt-6 space-y-4 text-sm leading-7 text-slate-600 sm:text-base">
                <p>
                  A Maylon utiliza tecnologia e monitoramento em tempo real para
                  oferecer viagens mais seguras, confortáveis e tranquilas para
                  mulheres.
                </p>

                <p>
                  Com compartilhamento de viagem, suporte da central de
                  segurança e verificação de motoristas, proporcionamos mais
                  proteção e confiança do embarque ao destino final.
                </p>
              </div>
        ...
        <div className="relative mx-auto max-w-7xl px-5 sm:px-8 lg:px-8">
          <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-20">
            ...
            <div className="max-w-xl">
              ...
              <div className="mt-6 space-y-4 text-sm leading-7 text-slate-600 sm:text-base">
                <p>
                  Para desenvolver soluções modernas e inteligentes, a Maylon
                  investe constantemente em inovação, reunindo uma equipe
                  altamente qualificada de engenheiros de software, analistas
                  de sistemas e especialistas em tecnologia.
                </p>

                <p>
                  Com profissionais atuando em arquitetura de sistemas,
                  desenvolvimento web, automação e análise de dados, a Maylon
                  transforma ideias em plataformas robustas e escaláveis.
                </p>

                <p>
                  A empresa também investe em pesquisa tecnológica e
                  capacitação contínua para garantir excelência em cada projeto
                  entregue.
                </p>
              </div>
            </div>
          ...
          <p className="mt-8 text-xs leading-5 text-slate-500">
            *As tecnologias e soluções podem variar conforme o projeto e a
