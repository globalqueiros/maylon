  ...
  const additionalTotal = useMemo(
    () =>
      selectedServicesData.reduce(
        (total, service) =>
          total + service.prices[selectedPlan],
        0
      ),
      ...
      <section className="mx-auto max-w-7xl px-4 pb-14 pt-8 sm:px-6 sm:pt-10 lg:px-8">
        ...
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mx-auto mt-3 max-w-2xl text-sm leading-6 text-slate-600 sm:text-base">
            Escolha o plano ideal para aproveitar ainda mais
            a experiência Maylon.
          </p>
        </div>
          ...
          {plans.map((plan) => {
            ...
            return (
              <button
                ...
                className={`relative flex min-h-[285px] w-full cursor-pointer flex-col rounded-3xl border-2 bg-white p-6 text-left transition-all duration-300 ${
                  selected
            ...
            <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
              ...
              <div className="flex items-start justify-between gap-4">
                ...
                <div>
                  ...
                  <p className="mt-1 text-xs leading-5 text-slate-500">
                    Serviços adicionais podem variar de preço
...
function PaymentOption({
  ...
  return (
    <button
      ...
      onClick={onClick}
      aria-pressed={selected}
      className={`flex w-full cursor-pointer items-center justify-between gap-4 rounded-2xl border-2 p-4 text-left transition-all duration-200 ${
        selected
...
function AdditionalService({
  ...
  return (
    <div
      className={`flex w-full items-center justify-between gap-4 rounded-2xl border-2 p-4 transition-all duration-200 ${
        selected
